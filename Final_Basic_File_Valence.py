...
def fullPlot(mean, quantiles, name="Plot.png", CCC=0, num = 0):
    for i in range(1, 10):
        ...
        fig.savefig('BasicFinal/' + name + '_Dev_' + str(i) + '.png', dpi=500)
        plt.close()
        #plt.show()
    f = open('BasicFinal/Basic' + str(num) + '.txt', mode='w')
...
# print(X.shape)
# print(Y.shape)
m = loadFile(X, Y, 'BasicFinal/Basic211.npy')
...
saveModel(m, name=('BasicFinal/Final.npy'))
